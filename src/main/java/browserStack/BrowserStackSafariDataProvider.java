...
public class BrowserStackSafariDataProvider {
		  ...
		  public Object[][] readExcel(String dataSheetName) throws IOException, InvalidFormatException{
			  File src = new File("./data/Safari1.xlsx");	
			...
			return obj;
			  ...
			  public void  BrowserStack(String BrowserName,String Version)throws InterruptedException, InvalidFormatException, IOException {
